# Refi My Oregon Loan — Deployment Checklist
...
3. **Verify your sending domain in Resend**
   Log in to resend.com and verify `refimyoregonloan.com` so `leads@refimyoregonloan.com` is authorized to send.
...
`🏠 New Lead: [Name] — [Loan Type] — refimyoregonloan.com`
